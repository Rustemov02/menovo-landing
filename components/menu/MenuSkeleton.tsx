/**
 * Menyu səhifəsi üçün reusable skeleton (loading) UI.
 *
 * Həm `loading.tsx` (server tərəf streaming fallback), həm də `page.tsx`-dəki
 * `useSearchParams` hydrasiya Suspense boundary-nın fallback-i kimi istifadə olunur.
 * Heç bir hook istifadə etmədiyi üçün həm Server, həm də Client Component-də
 * təhlükəsiz şəkildə render oluna bilər.
 */
