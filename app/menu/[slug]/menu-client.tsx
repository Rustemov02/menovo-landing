...
export default function MenuClient({
  ...
  return (
    <div className="min-h-screen bg-background text-on-background font-body-md pb-32">
      <main className="pb-6">
        <header className="relative w-full h-64 bg-surface-container-high overflow-hidden">
          <img
            ...
            src={restaurant.coverImage || "https://lh3.googleusercontent.com/aida-public/AB6AXuAC7pGIwOZtAlasOgXdYnlJQVoDgc512RGr-NUR13Q5kHpZK1iSqedEIVyHGLyE8UWiXIYzDJkdAhgxcBApyrTZpVs0Mxbggn-Cg4c0ixJ9_q1G-ga7OucWlGh76lHhkoerpIxtAtxz2CtZPc-hWgFeYO8swX5w0F4x32XJIWW7l5p97GB_YXaknwxevaRSFaGWBKIpA77fKQtZtLk1Qy5VbExTCVgPPoUw8DNV8QCCRPHMxMK6VtEc"}
          />
        ...
        <div className="px-margin-mobile mt-6 space-y-4">
          {Object.keys(grouped || {}).length === 0 ? (
            <div className="text-center py-20">
              <p className="text-xl text-on-surface-variant">Menyu məhsulları yoxdur.</p>
            </div>
          ) : (
      ...
      />
      <div
        className={`fixed bottom-0 left-0 right-0 z-[70] bg-surface rounded-t-[32px] p-6 shadow-[0_-10px_40px_rgba(0,0,0,0.1)] transform transition-transform duration-300 ease-out max-w-md mx-auto ${
